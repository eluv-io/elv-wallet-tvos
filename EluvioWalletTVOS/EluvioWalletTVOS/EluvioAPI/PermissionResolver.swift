...
enum PermissionResolver {
    ...
    static func resolvePermissions(
        ...
        resolveContentPermissions(permissionable, parentPermissions: parentPermissions, permissionStates: permissionStates)

        for child in permissionable.permissionChildren {
            resolvePermissions(child, parentPermissions: permissionable.resolvedPermissions, permissionStates: permissionStates)
        }
    }
    ...
    static func resolvePermissions(
        ...
        for permissionable in permissionables {
            resolvePermissions(permissionable, parentPermissions: parentPermissions, permissionStates: permissionStates)
        }
    }
        ...
        if let property = permissionable as? MediaProperty {
            ...
            if let ids = dto.property_permissions, !ids.isEmpty {
                let propDto = PermissionsDto(
                    ...
                    secondary_market_purchase_option: dto.property_permissions_secondary_market_purchase_option
                )
                property.resolvedPropertyPermissions = propDto.toResolvedPermission(permissionStates: permissionStates)
            }
            ...
            if let searchBehavior = dto.search_permissions_behavior {
                ...
                property.resolvedSearchPermissions = searchDto.toResolvedPermission(permissionStates: permissionStates)
            }
            ...
            if let ids = dto.page_permissions, !ids.isEmpty {
                ...
                page.resolvedPagePermissions = pageDto.toResolvedPermission(permissionStates: permissionStates)
            }
    ...
    private static func merge(
        ...
        if !parent.authorized {
            ...
            return ResolvedPermission(
                ...
                secondaryPurchaseOption: child.secondary_market_purchase_option ?? parent.secondaryPurchaseOption,
