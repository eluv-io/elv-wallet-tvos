...
class CacheManager: ObservableObject {
    ...
    func clearCacheOnAuthChange(previousAuthState: Bool?, currentAuthState: Bool, network: String) {
        // Clear cache when auth state changes to prevent showing wrong content
