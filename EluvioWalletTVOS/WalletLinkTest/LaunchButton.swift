...
struct LaunchButton: View {
  ...
  var buttonText = ""
  var highlightColor: Color = .init(hex: 0x2C59D3)
...
struct LaunchButton2: View {
  ...
  var buttonText = ""
  var highlightColor: Color = .init(hex: 0x2C59D3)
  var buttonColor: Color = .init(hex: 0x2C59D3)
  var highlightTextColor = Color.white
  var width: CGFloat = 380
  var height: CGFloat = 80
  var action: () -> Void
  ...
  var body: some View {
    ...
    .buttonStyle(
      IconButtonStyle(focused: isFocused, highlightColor: highlightColor, buttonColor: buttonColor)
    )
    .focused($isFocused)
  }
}
