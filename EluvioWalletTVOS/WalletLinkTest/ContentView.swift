...
func CreateFandangoPropertyLink(
  ...
  return fandangoPropertyBaseURL + "/\(marketplace)" + "?back_link=walletlink://"
    + (token.isEmpty ? "" : "&authorization=\(token)")
...
func CreateFandangoMintLink(
  ...
  return fandangoMintURL + "?" + "marketplace=\(marketplace)" + "&sku=\(sku)"
    + "&contract=\(contract)" + "&back_link=walletlink://"
    + (token.isEmpty ? "" : "&authorization=\(token)")
    + (address.isEmpty ? "" : "&address=\(address)")
}
...
func CreateMintLink(
  ...
  return mintBaseURL + "?" + "marketplace=\(marketplace)" + "&sku=\(sku)" + "&contract=\(contract)"
    + "&entitlement=\(entitlement)" + (authToken.isEmpty ? "" : "&authorization=\(authToken)")
            ...
            NavigationLink(
              destination:
                VuduPage(
                  ...
                  playOutPath:
                    "/q/hq__B1uYXysLE5XsGis2JUeTuBG8zfK7BaCy7Ng2DK8zmcLcyQArmTgc9B85ZfE5TDt1djQbGMmdbX/rep/playout/default/hls-clear/playlist.m3u8",
              ...
              Text(
                login.isLoggedOut
                  ? "A Quiet Place: Day One - Entitlement Minting (Requires Login)"
            ...
            NavigationLink(
              destination:
                VuduPage(
                  ...
                  playOutPath:
                    "/q/hq__3qChzMEkpzsJtde65yxekhnHZitGe43jBAz58PdU4e56KVxKUbPqQFYuvoPu2jCq3CDPJoDHRV/rep/playout/default/hls-clear/playlist.m3u8",
                  token: login.loginInfo?.token ?? ""
                )
            ) {
              Text(
            ...
            NavigationLink(
              destination:
                VuduPage(
                  ...
                  playOutPath:
                    "/q/hq__MVrabVyoxNPvJKCBiRstnhAsEyZXxBBwaRKvfSS413nfyepktJdFLmZ4q2D8uECNVQ2sxnH9JP/rep/playout/default/hls-clear/playlist.m3u8",
                  token: login.loginInfo?.token ?? "",
                  bundleButtonText: "Activate"
                )
            ) {
            ...
            NavigationLink(
              destination:
                TubiPage(
                  ...
                  playOutPath:
                    "/q/iq__3tfUq87qve9ywYu1jL3tGYfXk1ij/rep/playout/default/hls-clear/playlist.m3u8"
                )
            ) {
              Text(
            ...
            NavigationLink(
              destination:
                TubiPage(
                  ...
                  playOutPath:
                    "/q/iq__2EnYCsx2wn4dpbXDJAk137n9RPU6/rep/playout/default/hls-clear/playlist.m3u8"
                )
            ) {
              Text(
            ...
            NavigationLink(
              destination:
                TubiPage(
                  ...
                  playOutPath:
                    "/q/iq__2D4nVMqCEEEr3xaaxzZFXq9mKXr8/rep/playout/default/hls-aes128/playlist.m3u8",
                  playButtonText: "Play",
                  bundleButtonText: "Activate"
                )
            ) {
            ...
            NavigationLink(
              destination:
                UEFAPage(
                  ...
                  playOutPath:
                    "/q/iq__2HUxmn3xLv1vJMU8YLL7vmoKvqvY/rep/playout/default/hls-clear/playlist.m3u8"
                )
            ) {
              Text(
                "UEFA EURO2024"
            ...
            do {
                ...
                authToken: token)
              {
                if let string = entitlementJson.rawString() {
                  ...
                  let urlString = CreateMintLink(
                    contract: "", marketplace: marketplace, sku: sku, entitlement: string,
                    authToken: token)
